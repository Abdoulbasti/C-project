...
/*
timing_from_strings() :
-> recupère le temps en format chaine de caractère cassini
-> Le traduit en temps de type timing stocker dans la variable dest


timing_string_from_timing() : 
-> Fait le contraire de timing_from_strings()
-> Recupère un timing dest
-> Traduit dest en une representation textuel(du type passé en argument à cassini) 
*/